...
public class MileagePeriodController extends WindowController {
    private MainPage mainPage;
    private GridPane grid;

    public MileagePeriodController() {}

    public void openWindow(MileageRegisterController controller) {
        String windowTitle = "Реєстр: пройдений кілометраж - налаштування періоду";
